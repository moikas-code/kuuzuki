...
/**
 * Development script with hot reload using relaxed TypeScript compilation
 */
...
const compiledPath = join(projectRoot, 'dist-dev', 'index.js');

let serverProcess = null;
let isRebuilding = false;
let restartQueued = false;

console.log('🚀 Starting kuuzuki with hot reload (relaxed TypeScript)...');
console.log('👀 Watching for changes in:', srcDir);
console.log('⚠️  TypeScript errors are ignored in this mode');
