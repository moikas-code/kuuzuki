...
<a href="https://pkg.go.dev/github.com/sst/kuuzuki-sdk-go"><img src="https://pkg.go.dev/badge/github.com/sst/kuuzuki-sdk-go.svg" alt="Go Reference"></a>

The Opencode Go library provides convenient access to the [Opencode REST API](https://kuuzuki.ai/docs)
...
```go
import (
	"github.com/sst/kuuzuki-sdk-go" // imported as kuuzuki
)
```
...
```sh
go get -u 'github.com/sst/kuuzuki-sdk-go@v0.1.0-alpha.8'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/sst/kuuzuki-sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/sst/kuuzuki-sdk-go/issues) with questions, bugs, or suggestions.
