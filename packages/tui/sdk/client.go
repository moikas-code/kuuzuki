...
// DefaultClientOptions read from the environment (KUUZUKI_BASE_URL). This should
// be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("KUUZUKI_BASE_URL"); ok {
...
// environment (KUUZUKI_BASE_URL). The option passed in as arguments are applied
