...
:::caution Pro Feature
Sharing requires a Kuuzuki Pro subscription. [Learn more about API keys](/docs/apikey).
:::
...
3. Makes the conversation accessible via the shareable link — `kuuzuki.com/s/<share-id>`
