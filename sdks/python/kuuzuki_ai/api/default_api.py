...
from kuuzuki_ai.api_client import ApiClient, RequestSerialized
from kuuzuki_ai.api_response import ApiResponse
from kuuzuki_ai.rest import RESTResponseType
...
class DefaultApi:
    ...
    def get_config_providers(
        ...
        _param = self._get_config_providers_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_config_providers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AppProvidersResponse]:
        """List all providers
    ...
    @validate_call
    def get_config_providers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_config_providers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
